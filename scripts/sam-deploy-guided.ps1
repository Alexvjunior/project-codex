...
$aggregationWindow = $cfg["AGGREGATION_WINDOW_SECONDS"]
$paymentTimeout = $cfg["PAYMENT_TIMEOUT_MINUTES"]
$maxReschedules = $cfg["MAX_RESCHEDULES"]
$handoffTtl = $cfg["HANDOFF_TTL_MINUTES"]
$outboxMaxRetries = $cfg["OUTBOX_MAX_RETRIES"]
$maxTokensPerTurn = $cfg["MAX_TOKENS_PER_TURN"]
$monthlyBudgetUsd = $cfg["MONTHLY_BUDGET_USD"]
$queueMaxReceiveCount = $cfg["QUEUE_MAX_RECEIVE_COUNT"]
$orchestratorP95Latency = $cfg["ORCHESTRATOR_P95_LATENCY_MS"]
...
$overrides = @(
  ...
  "AggregationWindowSeconds=$aggregationWindow",
  "PaymentTimeoutMinutes=$paymentTimeout",
  "MaxReschedules=$maxReschedules",
  "HandoffTtlMinutes=$handoffTtl",
  "OutboxMaxRetries=$outboxMaxRetries",
  "MaxTokensPerTurn=$maxTokensPerTurn",
  "MonthlyBudgetUsd=$monthlyBudgetUsd",
  "QueueMaxReceiveCount=$queueMaxReceiveCount",
  "OrchestratorP95LatencyMs=$orchestratorP95Latency",
